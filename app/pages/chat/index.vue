  ...
  <NuxtLayout name="chat">
    <div :class="`mainContainer ${themedGlassContainer}`">
      ...
      <div v-if="!isMobile">
        ...
        <USeparator :class="`${themedSeparator}`" color="primary"></USeparator>
      </div>
        <!-- Container for Mobile -->
        <div v-if="isMobile">
          <h1 class="headlineChat-mobile">New Messages</h1>
          <USeparator :class="`${themedSeparatorMobile}`" color="primary"></USeparator>

          <!-- Direct -->
          <h1 class="headline-direct"> Direct Chats </h1>
          <!-- Loop through users array -->
          <div v-for="(chatroom, index) in directChatrooms" :key="chatroom.chatroom_id" 
            ...
            <div class="avatars-direct">
              <UChip inset color="primary">
                <UAvatar :src="chatroom.loggedUser.avatarUrl" size="lg"></UAvatar>
              </UChip>
            </div>
              ...
              <div class="avatars-group">
                <UAvatarGroup :max="1">
                  <UChip v-for="user in chatroom.users" :key="user.user_id" inset color="primary">
                    <UAvatar :src="user.avatarUrl" size="lg"></UAvatar>
                  </UChip>
                </UAvatarGroup>
              </div>
              <div class="count-new-messages">
